...
checked.addEventListener("click", function (e) {
	...
	if (checked.checked) {
		...
		cardBlock.lastElementChild.style.display = "block";
	} else {
		cardBlock.firstElementChild.style.display = "block";
		cardBlock.lastElementChild.style.display = "none";
	}
});
		...
		if (
			...
			if (
				...
				let gotoValueBlock =
					...
					pageYOffset -
					document.querySelector(".navMobile").offsetHeight;
				window.scrollTo({
					top: gotoValueBlock,
					behavior: "smooth",
				});
				document
					...
					.classList.toggle("activeNavMobile");
				...
				let gotoValueBlock =
					gotoBlock.getBoundingClientRect().top +
					pageYOffset -
					document.querySelector(".wrapp__navigation").offsetHeight;
				window.scrollTo({
					top: gotoValueBlock,
					behavior: "smooth",
				});
